...
$meta_box_options['nimbus_sidebar_meta_box']['fields']['alt_sidebar_select']
    = array('type'=>'textbox',
            'default'=>'',
            'script'=>'',
            'label'=>'Sidebar #:',
...
$meta_box_options['nimbus_featured_img_meta_box']['id'] = 'featured_img_meta_box';
$meta_box_options['nimbus_featured_img_meta_box']['title'] = 'Nimbus Featured Images';
$meta_box_options['nimbus_featured_img_meta_box']['callback'] = 'nimbus_call_featured_img_meta_box'; #create
$meta_box_options['nimbus_featured_img_meta_box']['post_type'] = 'page,post';
$meta_box_options['nimbus_featured_img_meta_box']['context'] = 'side';
$meta_box_options['nimbus_featured_img_meta_box']['priority'] = 'high';


$meta_box_options['nimbus_featured_img_meta_box']['fields']['include_image_on_page']
    = array('type'=>'radio',
            'options'=>array('true'=>'Show', 'hide'=>'Hide'),
            'default'=>'true',
            'script'=>'',
            'help'=>'Show/Hide Featured Image Banner');

add_action("admin_init", "nimbus_featured_img_meta_box");
add_action('save_post', 'nimbus_save_featured_img_meta_box');



function nimbus_featured_img_meta_box() {
    $key = 'nimbus_featured_img_meta_box';
    global $meta_box_options;
    $id = $meta_box_options[$key]['id'];
    $title = $meta_box_options[$key]['title'];
    $callback = $meta_box_options[$key]['callback'];
...
function nimbus_call_featured_img_meta_box() {
    ...
    $fields = $meta_box_options[$key]['fields'];
    nimbus_output_metabox_style($meta_box_options['nimbus_featured_img_meta_box']['id'], $meta_box_options['nimbus_featured_img_meta_box']['context']);
    nimbus_metabox_nonce();
    nimbus_draw_fields($fields, $post->ID);
...
function nimbus_save_featured_img_meta_box($post_id) {
